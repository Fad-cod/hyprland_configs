...
hl.curve("workspacesBezier", { type = "bezier", points = { { 0.2, 1.5 }, { 0.4, 1 } } })
hl.curve("windowsInBezier", { type = "bezier", points = { { 0.2, 1.5 }, { 0.4, 1 } } })
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4, bezier = "windowsInBezier", style = "slide" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 6, bezier = "windowsInBezier", style = "slide" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 8, bezier = "windowsInBezier", style = "slide" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 8, bezier = "workspacesBezier", style = "slide" })
